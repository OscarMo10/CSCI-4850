...
create_account.php - Allows user to create an account. Will display for to allow user to input data. File makes 3 insert queries into person, customer, and person_phoneNumber. 
...
myaccount.php - Displays the items the current user has purchase. Make query to database to retrieve purchased items. 
...
/*********** RUNNING PHP SCRIPTS *****************/
	...
	3. Visit 'create_account.php'. Page displays form that allows you to create an account. The 'Populate with Valid Data' button populates the fields of the forms with valid data.
	...
	6. 'myaccount.php' will show all the items which you have bought.
